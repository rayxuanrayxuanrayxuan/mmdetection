...
from mmdet.datasets.yolox.samplers import YoloBatchSampler
from mmdet.datasets.yolox.dataloading import DataLoader
...
def train_detector(model,
    ...
    if validate:
        ...
        val_dataloader = mmdet_build_dataloader(
            val_dataset,
